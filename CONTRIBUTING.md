...
The text within this document are not _set in stone_ rules but guidelines, and much like other files maintained by github-utilities the following may be edited via a _`Pull Request`_.
...
Review the [whole thing][branch__current__code_of_conduct] to see what is expected of those that maintain code with github-utilities
...
Join the <sub>[![Contributors][badge__contributors]][branch__current__network_members]</sub> issuing Pull Requests that close available <sub>[![Open Issues][badge__issues]][branch__current__issues]</sub>. [New Issues][branch__current__issues_new] may be opened for Reporting Bugs and Suggesting Enhancements. However, please search for existing similar Issues first; example search for [`memory-leaks`](https://github.com/github-utilities/.github/search?q=memory-leaks&type=Issues) from the `.github` repository.
...
```Bash
_git_name='your-name'
_organization='github-utilities'
...
set _organization='github-utilities'
...
There may be _`orphan`_ branches utilized by github-utilities for separating Code to be included in other projects from Documentation and Usage Examples. Non-orphaned development branches are encouraged when adding features or fixing bugs.
...
```
Organization that aims to assist with building healthy GitHub repositories
Copyright (C) 2020 S0AndS0
...
[branch__current__network_members]:
  network/members
  "Perhaps you too may be counted amount those that have Forked repositories maintain by github-utilities"

[branch__current__support]:
  SUPPORT.md
  "Best avenues for seeking support of github-utilities"
...
[badge__issues]: https://img.shields.io/github/issues/github-utilities/.github.svg

[badge__contributors]: https://img.shields.io/github/forks/github-utilities/.github.svg?color=005571&label=Contributors
